...
['editMessageMedia'] = ' function > LuaTele.editMessageMedia(chat_id, message_id, type, media, caption, parse_mode, reply_markup)',
...
['revokeChatInviteLink'] = ' function > LuaTele.revokeChatInviteLink(chat_id, name)',
...
function luatele_function.editMessageMedia(chat_id, message_id, type, media, caption, parse_mode, reply_markup)
if type == "photo" then
input_message_content = {
luatele = 'inputMessagePhoto',
photo = luatele_function.getInputFile(media),
caption = {text = caption or ''}
}
elseif type == "video" then
input_message_content = {
luatele = 'inputMessageVideo',
video = luatele_function.getInputFile(media),
caption = {text = caption or ''}
}
elseif type == "audio" then
input_message_content = {
luatele = 'inputMessageAudio',
audio = luatele_function.getInputFile(media),
caption = {text = caption or ''}
}
elseif type == "animation" then
input_message_content = {
luatele = 'inputMessageAnimation',
animation = luatele_function.getInputFile(media),
caption = {text = caption or ''}
}
elseif type == "document" then
input_message_content = {
luatele = 'inputMessageDocument',
document = luatele_function.getInputFile(media),
caption = {text = caption or ''}
}
end
local luatele_body = {
luatele = 'editMessageMedia',
chat_id = chat_id,
message_id = message_id,
reply_markup = reply_markup,
input_message_content = input_message_content
...
if parse_mode then
luatele_body.input_message_content.caption = luatele_function.parseTextEntities(caption,parse_mode)
end
return function_core.run_table(luatele_body)
end
...
function_core.send_tdlib(luatele.config.parameters)
